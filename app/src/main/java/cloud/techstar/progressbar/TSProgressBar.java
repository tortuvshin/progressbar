...
public class TSProgressBar extends View {
    ...
    public TSProgressBar(Context context) {
        super(context);
        init(null, 0);
    }

    public TSProgressBar(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }

    public TSProgressBar(Context context, AttributeSet attrs, int defStyleAttr) {
